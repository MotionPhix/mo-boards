        ...
        <div class="space-y-8">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Timezone, currency and formatting</CardDescription>
            </CardHeader>
            <CardContent class="grid grid-cols-1 gap-6 md:grid-cols-2">
              <div>
                ...
                <Select v-model="form.timezone" class="mt-1">
                  ...
                  <SelectContent>
                    <SelectItem v-for="tz in options.timezones" :key="tz.value" :value="tz.value">
                      {{ tz.label }}
                    </SelectItem>
                  </SelectContent>
                </Select>
              ...
              <div>
                ...
                <Select v-model="form.currency" class="mt-1">
                  ...
                  <SelectContent>
                    <SelectItem v-for="c in options.currencies" :key="c.value" :value="c.value">
                      {{ c.label }}
                    </SelectItem>
                  </SelectContent>
                </Select>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Default payment terms and tax configuration</CardDescription>
            </CardHeader>
            <CardContent class="grid grid-cols-1 gap-6 md:grid-cols-2">
              <div>
                <NumberField 
              ...
              <div>
                <NumberField 
                    ...
                    :step="0.01" 
                    :min="0" 
                    :max="100" v-model.number="form.late_fee_percentage"
                    :format-options="{
                        style: 'percent',
                    }">
              ...
              <div class="md:col-span-2 flex items-center gap-2">
                <Switch id="auto_generate_invoices" v-model:checked="form.auto_generate_invoices" />
          ...
          <div class="flex justify-end">
            <Button type="submit" :disabled="form.processing">Save Business Settings</Button>
          </div>
        </div>
      </form>
    </CompanySettingsLayout>
