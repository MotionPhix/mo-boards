...
<template>
  <BaseDashboard v-bind="props">
    <template #welcome-message>
      You have full system access across all companies and features.
    </template>

    <template #dashboard-content="sp">
      <!-- bring slot props into template scope -->
      <component :is="sp.Card">
        <!-- no-op to ensure TS sees sp in use -->
      </component>
      <!-- Stats Cards - Super Admin sees everything -->
