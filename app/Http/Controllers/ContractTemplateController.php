...
final class ContractTemplateController extends Controller
{
    ...
    protected function preview(ContractTemplate $contractTemplate): Response
    {
    ...
    protected function purchase(Request $request, ContractTemplate $contractTemplate)
    {
    ...
    protected function processPayment(Request $request, ContractTemplate $contractTemplate)
    {
        $request->validate([
    ...
    protected function marketPlace(): Response
    {
        $company = Auth::user()->currentCompany;
    ...
    protected function exportPdf(ContractTemplate $template)
    {
        $company = Auth::user()->currentCompany;
